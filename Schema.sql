...
CREATE INDEX IF NOT EXISTS idx_checkpoints_trip ON checkpoints(trip_id);
CREATE INDEX IF NOT EXISTS idx_maintenance_vehicle ON maintenance(vehicle_id);
CREATE INDEX IF NOT EXISTS idx_maintenance_status ON maintenance(status);
CREATE INDEX IF NOT EXISTS idx_maintenance_scheduled ON maintenance(scheduled_at);
